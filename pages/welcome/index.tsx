        ...
        <div className='max-w-4xl mx-auto space-y-12'>
          ...
          <div className='text-center space-y-6'>
            ...
            <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-purple-500/20 mb-4'>
              ...
              <span className='text-sm font-medium text-purple-600 dark:text-purple-400'>¡Cuenta creada exitosamente!</span>
            </div>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  ...
                  <div className='inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-purple-500 to-blue-600 mt-2'>
                    ...
                    <span className='text-xs text-white font-semibold'>ADMINISTRADOR</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <div className='space-y-8'>
            <div className='text-center space-y-2'>
              ...
              <p className='text-muted-foreground'>Acceso completo a todas las funcionalidades de la plataforma</p>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
              <Card className='glass border-purple-500/20 hover:border-purple-500/40 hover:-translate-y-2 transition-all duration-300 group'>
                <CardContent className='pt-6 space-y-4'>
                  ...
                  <h3 className='font-semibold text-lg'>Gestionar Movimientos</h3>
              ...
              <Card className='glass border-blue-500/20 hover:border-blue-500/40 hover:-translate-y-2 transition-all duration-300 group'>
                <CardContent className='pt-6 space-y-4'>
                  ...
                  <h3 className='font-semibold text-lg'>Administrar Usuarios</h3>
                  <ul className='text-sm text-muted-foreground space-y-2'>
                    <li className='flex items-start gap-2'>
          ...
          <Card className='glass border-purple-500/20 bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-cyan-500/10'>
            <CardContent className='pt-10 pb-10 text-center space-y-6'>
              ...
              <p className='text-lg text-muted-foreground max-w-xl mx-auto'>
                Accede al dashboard y empieza a gestionar tus finanzas de manera profesional
              </p>
              <Link href='/dashboard'>
                <Button size='lg' className='text-lg px-10 py-6 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg shadow-purple-500/50 hover:shadow-purple-500/70 transition-all duration-300'>
                  Ir al Dashboard
