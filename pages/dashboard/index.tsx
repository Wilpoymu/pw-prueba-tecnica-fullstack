...
const Dashboard = () => {
      ...
      try {
        ...
        while (hasMore) {
          const response = await fetch(
            `/api/movements?page=${page}&limit=100&sortBy=date&sortOrder=desc`
          );
  ...
  const cambioSaldo =
    balanceMesPasado !== 0
      ? ((balanceMesActual - balanceMesPasado) / Math.abs(balanceMesPasado)) *
        100
      : balanceMesActual > 0
        ? 100
        : 0;
            ...
            <div className='relative flex items-start justify-between flex-wrap gap-4'>
              ...
              <div className='glass px-6 py-4 rounded-2xl border border-purple-500/20 space-y-2'>
                <div className='flex items-center gap-2'>
                  <EstadoIcon
                    className={`h-5 w-5 ${estadoFinanciero.textColor}`}
                  />
                ...
                <div className='flex items-center gap-3'>
                  <Badge
                    className={`${estadoFinanciero.color} text-white border-0 px-4 py-1.5 text-base font-semibold shadow-lg`}
                  >
            ...
            <Card className='relative overflow-hidden border-purple-200/50 dark:border-purple-900/50 bg-gradient-to-br from-white to-purple-50/50 dark:from-gray-900 dark:to-purple-950/20'>
              ...
              <CardContent className='relative'>
                ...
                <div className='flex items-center gap-2 mt-2'>
                  ...
                  >
                    {isFinite(cambioSaldo)
                      ? `${cambioSaldo > 0 ? '+' : ''}${cambioSaldo.toFixed(1)}%`
                      : 'N/A'}
                  </Badge>
                  <p className='text-xs text-muted-foreground'>vs mes pasado</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className='relative overflow-hidden border-blue-200/50 dark:border-blue-900/50 bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-900 dark:to-blue-950/20'>
              ...
              <CardContent className='relative'>
                <div className='text-3xl font-bold text-blue-600 dark:text-blue-400'>
                  $
                  {ingresosDelMes.toLocaleString('es-MX', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </div>
            ...
            <Card className='relative overflow-hidden border-pink-200/50 dark:border-pink-900/50 bg-gradient-to-br from-white to-pink-50/50 dark:from-gray-900 dark:to-pink-950/20'>
              ...
              <CardContent className='relative'>
                <div className='text-3xl font-bold text-pink-600 dark:text-pink-400'>
                  $
                  {egresosDelMes.toLocaleString('es-MX', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </div>
                <div className='flex items-center gap-2 mt-2'>
                  <Badge
                    variant='outline'
                    className='text-xs border-pink-500/30 text-pink-600 dark:text-pink-400'
                  >
                    {isFinite(cambioEgresos)
              ...
              <div className='grid gap-4 md:grid-cols-3'>
                <div className='space-y-2'>
                  ...
                  <p className='text-2xl font-bold text-gradient'>
                    $
                    {(ingresosDelMes - egresosDelMes).toLocaleString('es-MX', {
                      minimumFractionDigits: 2,
                    })}
                  </p>
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    {ingresosDelMes / egresosDelMes >= 3
                      ? 'Muy saludable'
                      : ingresosDelMes / egresosDelMes >= 2
                        ? 'Saludable'
                        : 'Puede mejorar'}
                  </p>
                </div>
              ...
              <Card className='border-blue-200/50 dark:border-blue-900/50 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20 relative overflow-hidden'>
                ...
                <CardContent className='pt-6 relative'>
                  <p className='text-sm text-blue-900 dark:text-blue-100'>
                    ...
                    Como usuario estándar, tienes acceso a la gestión de
                    movimientos. Los administradores pueden acceder a funciones
                    adicionales como gestión de usuarios y reportes.
                  </p>
                </CardContent>
              </Card>
            }
