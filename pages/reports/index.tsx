...
export default function ReportsPage() {
  ...
  const [startDate, setStartDate] = useState<Date>(subMonths(startOfMonth(new Date()), 2));
  ...
  const savingsRate = summaryData
    ? summaryData.totalIncome > 0
      ? ((summaryData.totalIncome - summaryData.totalExpense) / summaryData.totalIncome) * 100
      : 0
    : 0;
              ...
              <Card className="border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-xl">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    ${summaryData.currentBalance.toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                  </div>
              ...
              <Card className="border-purple-500/20 bg-card/50 backdrop-blur-xl">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-600">
                    ${summaryData.totalIncome.toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              <Card className="border-purple-500/20 bg-card/50 backdrop-blur-xl">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-red-600">
                    ${summaryData.totalExpense.toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-right">
                          ...
                          <p className="font-semibold text-green-600">
                            ${period.income.toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-sm text-muted-foreground">Egresos</p>
                          <p className="font-semibold text-red-600">
                            ${period.expense.toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                          </p>
                        </div>
                        <div className="text-right min-w-[120px]">
                          ...
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <p className={`font-bold ${period.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                              ${Math.abs(period.balance).toLocaleString('es-MX', { minimumFractionDigits: 2 })}
                            </p>
                          </div>
                        </div>
                      </div>
